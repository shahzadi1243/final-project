...
export default function CompleteCombinedComponent() {
  ...
  if (activeSubService && activeCategory) {
    return (
      <div className="min-h-screen flex flex-col bg-[#1A102F] font-sans text-purple-100 selection:bg-purple-500 selection:text-white">
        {/* Navigation Top Bar */}
        <nav className="w-full bg-[#241640] shadow-md px-6 py-4 flex items-center justify-between border-b border-purple-900/50">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setActiveSubService(null)}
              className="px-4 py-2 bg-[#1A102F] text-purple-200 rounded-xl font-bold text-xs sm:text-sm shadow hover:bg-[#150D26] transition flex items-center gap-2 cursor-pointer border border-purple-800/60 hover:border-purple-500"
            >
        ...
        {/* Hero Section Banner */}
        <div className="bg-[#241640] py-12 px-4 text-center text-white space-y-4 border-b border-purple-900/50">
          <span className="inline-block px-4 py-1.5 bg-purple-900/60 text-purple-200 text-xs font-semibold rounded-full border border-purple-700/60">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 w-full flex-1 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            {/* Left Image Box */}
            <div className="relative h-72 sm:h-96 rounded-3xl overflow-hidden shadow-xl border border-purple-900/50 bg-[#241640]">
              <Image
            ...
            <div className="relative h-72 sm:h-96 rounded-3xl overflow-hidden shadow-xl bg-black flex items-center justify-center border border-purple-900/50">
          ...
          <div className="flex items-center gap-2 pt-4">
            <span className="p-2.5 bg-[#241640] text-purple-300 rounded-xl text-sm border border-purple-900/50 shadow-md">📍</span>
            <div className="px-5 py-2.5 bg-[#241640] text-purple-200 font-semibold text-xs sm:text-sm rounded-xl border border-purple-900/50 shadow-md">
            ...
            <div className="max-w-md mx-auto pt-4">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-[#241640] border border-purple-800/60 text-purple-100 placeholder-purple-400/70 rounded-2xl shadow-xl text-sm focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition"
                />
              </div>
            </div>
          </div>
            ...
            {filteredSubServices.length > 0 ? (
              filteredSubServices.map((sub) => (
                <div
                  ...
                  className="group bg-[#241640] rounded-3xl overflow-hidden border border-purple-900/50 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer flex flex-col hover:border-purple-500/60 hover:-translate-y-1"
                >
                  <div className="relative h-64 w-full overflow-hidden bg-[#150D26]">
                    <Image
                      src={sub.image}
                      alt={sub.title}
                      fill
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-4 pt-4 border-t border-purple-900/50 flex items-center justify-between text-xs text-purple-300 font-semibold">
                      <span className="text-purple-200">Available in: {sub.cities.join(", ")}</span>
                      <span className="text-purple-400 font-bold group-hover:translate-x-1 transition-transform duration-300">View Details &rarr;</span>
                    </div>
                  </div>
                </div>
              ))
            ) : (
              <div className="col-span-full text-center text-purple-300 py-12 bg-[#241640] rounded-3xl border border-purple-900/50">
    ...
    <div className="min-h-screen flex flex-col bg-[#1A102F] font-sans text-purple-100 selection:bg-purple-500 selection:text-white">
      ...
      <nav className="w-full bg-[#241640] shadow-md px-6 py-4 flex items-center justify-between border-b border-purple-900/50">
        <div className="flex items-center gap-3">
          <a
            href="/"
            className="px-4 py-2 bg-[#1A102F] text-purple-200 rounded-xl font-bold text-sm shadow hover:bg-[#150D26] transition flex items-center gap-2 border border-purple-800/60 hover:border-purple-500"
          >
            🏠 Home
          </a>
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full flex-1">
        <section className="space-y-8">
            ...
            <div className="max-w-md mx-auto pt-2">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-[#241640] border border-purple-800/60 text-purple-100 placeholder-purple-400/70 rounded-2xl shadow-xl text-sm focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition"
                />
              </div>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center py-6 min-h-[460px]">
            ...
            <button
              onClick={handlePrev}
              className="absolute left-2 sm:left-12 z-30 w-12 h-12 bg-[#241640] rounded-full shadow-lg border border-purple-800/60 flex items-center justify-center text-purple-300 hover:bg-[#150D26] hover:border-purple-500 transition cursor-pointer"
            >
              ❮
            </button>
                ...
                return (
                  matchesSearch && (
                    <div
                      ...
                      className={`absolute transition-all duration-500 ease-out cursor-pointer w-72 sm:w-80 h-[380px] rounded-3xl overflow-hidden shadow-2xl border border-purple-800/60 bg-[#241640] flex flex-col justify-end p-6 transform ${transformStyle} ${
                        isCenter ? "ring-2 ring-purple-500/60 border-purple-500 shadow-2xl" : ""
                      }`}
                    >
                      <div className="absolute inset-0 z-0 bg-[#150D26]">
                        <Image src={service.image} alt={service.title} fill sizes="100vw" className="object-cover opacity-85" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#1A102F] via-[#1A102F]/70 to-transparent"></div>
                      </div>
            ...
            <button
              onClick={handleNext}
              className="absolute right-2 sm:right-12 z-30 w-12 h-12 bg-[#241640] rounded-full shadow-lg border border-purple-800/60 flex items-center justify-center text-purple-300 hover:bg-[#150D26] hover:border-purple-500 transition cursor-pointer"
            >
              ❯
            </button>
          </div>
              ...
              <button
                ...
                className={`transition-all rounded-full cursor-pointer ${
                  currentIndex === idx
                    ...
                    : "w-2.5 h-2.5 bg-purple-900 hover:bg-purple-800"
                }`}
              ></button>
            ))}
          </div>
...
function Footer() {
  return (
    <footer className="w-full bg-[#241640] text-purple-300 py-8 px-6 border-t border-purple-900/50 mt-auto shadow-2xl">

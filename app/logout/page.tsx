  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-slate-950 via-purple-950 to-slate-950 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-md w-full text-center">
        ...
        {/* Logout Container */}
        <div className="bg-slate-900/80 backdrop-blur-md rounded-2xl shadow-2xl border border-purple-900/50 p-8">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">You have been logged out</h2>
          <p className="text-gray-300 mb-6 text-sm">
            Aapka account successfully logout ho chuka hai. Dobara access karne ke liye login karein.
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              Login Again <ArrowRight size={18} />
            </Link>
            
            <Link
              href="/"
              className="w-full inline-flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-gray-200 py-3 rounded-xl font-medium transition border border-purple-950 text-sm"
            >
              Go to Home Page
            </Link>
          </div>

    ...
    <div className="min-h-screen bg-gradient-to-r from-slate-950 via-purple-950 to-slate-950 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-3xl w-full">
        ...
        <div className="flex items-center justify-center gap-3 mb-8 group cursor-default">
          <Package className="text-purple-400 transform group-hover:scale-110 transition duration-300" size={38} />
        ...
        {/* Orders Container */}
        <div className="bg-slate-900/80 backdrop-blur-md rounded-2xl shadow-2xl border border-purple-900/50 p-8 text-center transition-all duration-300 hover:border-purple-500 hover:shadow-[0_0_30px_rgba(168,85,247,0.3)]">
          ...
          <p className="text-gray-300 mb-6 max-w-sm mx-auto text-sm leading-relaxed">
            Aapne abhi tak koi house design ya map order nahi kiya hai. Jab aap order karenge, toh uski details yahan show hongi.
          </p>
